            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="cate_name" placeholder="请输入分类名称" value="{{old('cate_name')}}">
                    ...
                    <tr>
                        <th>分类标题：</th>
                        <td>
                            <input type="text" class="lg" name="cate_title" placeholder="请输入分类标题" value="{{old('cate_title')}}">
                        </td>
                    </tr>
                    <tr>
                        <th>关键词：</th>
                        <td>
                            <textarea name="cate_keywords" placeholder="请输入分类的关键词">{{old('cate_keywords')}}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>描述：</th>
                        <td>
                            <textarea name="cate_description" placeholder="请输入分类的描述">{{old('cate_description')}}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" class="sm" name="cate_order" value="{{old('cate_order')}}" placeholder="输入为正整数">
